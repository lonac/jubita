...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Retirement Details</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="{{route('dashboard')}}">Dashboard</a></li>
                <li><a href="#">Retirement Assessments</a></li>
    ...
    <div class="row">
        <div class="col-md-4 col-xs-12">
            @include('imprest.retirements._profile')
        </div>

        <!-- EXPENSE ITEMS -->
        <div class="col-md-8 col-xs-12">

            @include('imprest.retirements._preview')
            ...
            <div class="white-box">
                ...
                @if($canApprove)
                <form method="POST" action="{{ route('approval.update', $currentApproval->id) }}">
                    @csrf
